...
#define CONFIGURE_COMMAND " './configure'  '--without-iconv' '--without-valgrind' '--enable-fpm'"
...
#define PHP_EXTENSION_DIR       "/usr/local/lib/php/extensions/no-debug-non-zts-20170718"
